...
# rmarkdown::render("Code/Rmd/FZJ ATS Pilot 2018 Data Cleaning.Rmd", output_dir="Drafts", output_format = c("html_document",  "pdf_document", "word_document"))
#
# [todo] Figure out whether the Word errors when running the above command are what is keeping this from working:
