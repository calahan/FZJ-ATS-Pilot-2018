...
Forschungszentrum-Jülich conducted by IBG-2/Alternative Biomass (for details, see
Methods). Briefly: water quality and biomass productivity data were entered manually
into the spreadsheet `ATS Treatment.xlsx`. Biomass composition data were obtained 
by standard analyses and recorded in the spreadsheet `Analysen ZEA-3.xlsx`. Temperature
and irradiance data were obtained from data loggers. Data cleaning comprised rearranging,
renaming, or deleting various cells or observations to achieve tidy data.
